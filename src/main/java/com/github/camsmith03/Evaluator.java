...
public class Evaluator {
    ...
    PLAN:
        ...
        Second, we have to determine who will be building the heap of evaluated integers.
            ...
            solution. We can create a Heap data structure designed for integers, then interface with Evaluator for every
            MoveList element until they are all appended to the Heap.
            ...
            puts our design for MovList at a disadvantage.
